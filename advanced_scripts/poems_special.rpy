...
image poem_specialposter = "mod_assets/poster.png"

label poem_special_poster:
    $ quick_menu = False
    play sound page_turn
    show poem_specialposter with Dissolve(1.0)
    $ pause()
    $ quick_menu = True
    hide poem_specialposter with Dissolve(1.0)
    return
