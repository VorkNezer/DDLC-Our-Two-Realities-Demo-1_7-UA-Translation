define config.name = "DDLC Our Two Realities"
define gui.show_name = True
define config.version = "1.7_DEMO"
define gui.about = _("")
define build.name = "OurTwoRealities"
...
define config.save_directory = "Our_Two_Realities"
